export default function MirrorSyncHome() {
  return (
    <div>
      <style jsx>{`
        .container { min-height: 100vh; background: linear-gradient(to bottom, #1a1a2e 0%, #0f0f23 50%, #1a1a2e 100%); color: white; }
        .header { position: fixed; top: 0; width: 100%; background: rgba(0,0,0,0.8); backdrop-filter: blur(10px); border-bottom: 1px solid rgba(147,51,234,0.2); z-index: 50; padding: 1.5rem; }
        .nav { max-width: 1200px; margin: 0 auto; display: flex; justify-content: space-between; align-items: center; }
        .logo { font-size: 1.5rem; font-weight: bold; background: linear-gradient(to right, #a855f7, #22d3ee); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
        ...
        h1 { font-size: 4.5rem; font-weight: 900; line-height: 1.1; margin-bottom: 2rem; background: linear-gradient(135deg, #a855f7 0%, #22d3ee 50%, #10b981 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
        ...
        .btn { display: inline-block; padding: 1.2rem 3rem; border-radius: 12px; font-weight: 700; font-size: 1.1rem; text-decoration: none; margin: 0.5rem; cursor: pointer; border: none; transition: all 0.3s; }
        ...
        .stat-value { font-size: 3rem; font-weight: 900; background: linear-gradient(to right, #a855f7, #22d3ee); -webkit-background-clip: text; -webkit-text-fill-color: transparent; margin-bottom: 0.5rem; }
        ...
        .number { font-size: 4rem; font-weight: 900; background: linear-gradient(to right, #a855f7, #22d3ee); -webkit-background-clip: text; -webkit-text-fill-color: transparent; margin-bottom: 1rem; }
        ...
        @media (max-width: 768px) { h1 { font-size: 2.5rem; } .email-form { flex-direction: column; } }
      `}</style>
